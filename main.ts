...
function startgame () {
    controller.moveSprite(Aaron, 100, 100)
    scene.cameraFollowSprite(Aaron)
    tiles.placeOnTile(Aaron, tiles.getTileLocation(5, 26))
    Aaron = sprites.create(assets.image`Aaron`, SpriteKind.Player)
